...
#include "../../../rf-common/vartypes/primitives/VarInt.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarInt_t, stringdata) + ofs \
...
const QMetaObject VarTypes::VarInt::staticMetaObject = {
    { &VarTypeTemplate<VarIntVal>::staticMetaObject, qt_meta_stringdata_VarTypes__VarInt.data,
      qt_meta_data_VarTypes__VarInt,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VarTypes::VarInt::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarInt.stringdata))
