...
#include "../../../rf-common/vartypes/primitives/VarSelection.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarSelection_t, stringdata) + ofs \
...
const QMetaObject VarTypes::VarSelection::staticMetaObject = {
    { &VarType::staticMetaObject, qt_meta_stringdata_VarTypes__VarSelection.data,
      qt_meta_data_VarTypes__VarSelection,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VarTypes::VarSelection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarSelection.stringdata))
