...
#include "../../../rf-common/vartypes/primitives/VarString.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarString_t, stringdata) + ofs \
...
const QMetaObject VarTypes::VarString::staticMetaObject = {
    { &VarTypeTemplate<VarStringVal>::staticMetaObject, qt_meta_stringdata_VarTypes__VarString.data,
      qt_meta_data_VarTypes__VarString,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VarTypes::VarString::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarString.stringdata))
