...
#include "../../../rf-common/vartypes/primitives/VarExternal.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_VarTypes__VarExternal_t, stringdata) + ofs \
...
const QMetaObject VarTypes::VarExternal::staticMetaObject = {
    { &VarList::staticMetaObject, qt_meta_stringdata_VarTypes__VarExternal.data,
      qt_meta_data_VarTypes__VarExternal,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VarTypes::VarExternal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VarTypes__VarExternal.stringdata))
